export const chapterCourses = {
  reels: {
    ...
    sections: [
      ...
      { title: "Ordre de grandeur et écriture scientifique", text: "Tout réel non nul s’écrit a × 10ⁿ avec 1 ≤ |a| < 10. n = E(log₁₀ |N|). L’ordre de grandeur arrondit a à l’unité. Un calcul d’ordre de grandeur précède le calcul exact : il détecte une virgule oubliée. Temps = distance / vitesse, après mise en unités cohérentes (millions de km → km, puis s → min)." },
  ...
  polynomes: {
    ...
    sections: [
      ...
      { title: "Évaluation et Horner", text: "P(1) = somme des coefficients. P(0) = terme constant. P(−1) = somme alternée. Horner réduit les puissances : P = ((aₙ x + aₙ₋₁) x + … ) x + a₀. Moins d’opérations, et le même schéma sert à la division par x − r." },
      { title: "Racines et factorisation", text: "α est racine ⇔ P(α) = 0 ⇔ (x − α) divise P. Un polynôme de degré n a au plus n racines. Si P a plus de racines que son degré, P est identiquement nul. Racine entière : elle divise a₀. On teste les diviseurs de a₀, puis Horner donne le quotient." },
      { title: "Exemple type", text: "x³ + 6x² + 12x − 56. Les diviseurs de 56 : ±1, ±2, ±4, … P(2) = 8 + 24 + 24 − 56 = 0, donc 2 est racine. Horner : quotient x² + 8x + 28, discriminant 64 − 112 < 0 : une seule racine réelle." },
      ...
      { title: "Sommes d’entiers", text: "S₁ = 1 + … + n = n(n+1)/2. S₂ = 1² + … + n² = n(n+1)(2n+1)/6. Ces formules s’obtiennent en sommant une différence télescopique P(k) − P(k − 1). Attention : (S₁)² = somme des cubes, pas S₂. Pour n = 10 : S₁ = 55, S₂ = 385." },
      { title: "Méthode type", text: "Évaluer en un point simple. Chercher une racine évidente. Factoriser par Horner. Étudier le quotient (trinôme : Δ). Conclure sur les racines et le signe." },
  ...
  translations: {
    ...
    sections: [
      ...
      { title: "Composition", text: "t_u⃗ ∘ t_v⃗ = t_{u⃗+v⃗}. Les translations forment un groupe commutatif isomorphe au groupe des vecteurs." },
  ...
  rotations: {
    ...
    sections: [
      ...
      { title: "Formules générales", text: "x' = x_O + (x − x_O) cos α − (y − y_O) sin α, y' = y_O + (x − x_O) sin α + (y − y_O) cos α. L’angle de l’énoncé est en degrés ; le calcul trigonométrique utilise la conversion π/180 si besoin. 90° : cos = 0, sin = 1. 180° : cos = −1, sin = 0." },
      ...
      { title: "Méthode type", text: "Identifier le centre et l’angle. Si O n’est pas l’origine, se ramener au vecteur OM⃗. Appliquer la matrice. Contrôler OM' = OM et, pour 90°, OM⃗ · OM'⃗ = 0." },
